...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String DatabaseName = "MyCity"; // поле названия БД
    private static final int DatabaseVersion = 1; // поле версии БД

    private static final String tableName = "myCity"; // поле названия таблицы в БД
    ...
    public void addCity(String title) {
    ...
    public void updateCity(String title, String id){
